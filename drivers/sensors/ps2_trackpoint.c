...
report_mouse_t ps2_mouse_get_report(report_mouse_t preview_mouse_report) {
...
uprintf("PS2_MOUSE_SCROLL_BTN_MASK_1,%d", tp_buttons);
...
static inline void ps2_mouse_scroll_button_task(report_mouse_t *mouse_report) {
uprintf("PS2_MOUSE_SCROLL_BTN_MASK_2,%d %d", PS2_MOUSE_SCROLL_BTN_MASK, mouse_report->buttons);
    if (PS2_MOUSE_SCROLL_BTN_MASK == (mouse_report->buttons & (PS2_MOUSE_SCROLL_BTN_MASK))) {
uprintf("PS2_MOUSE_SCROLL_BTN_MASK_3");
...
uprintf("PS2_MOUSE_SCROLL_BTN_MASK_4");
